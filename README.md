...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dlx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14741&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dlx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dlx` can be installed with:

```
conda install dlx
```

It is possible to list all of the versions of `dlx` available on your platform with:
